...
import { activity, circleAlert, circleCheck, download, globe, plus, rotateCw, rss, shieldCheck, upload, x } from "../lib/icons";
...
export function Sources({ sources, refreshingId, status, onAdd, onRemove, onRefresh, onOpenBrowser, onImport, onExportFile, onImportFile }: SourcesProps) {
