  ...
  return (
    <div className="section-stack export-page">
      <div className="cat-header" style={{ marginBottom: 4 }}>
        ...
        <span className="cat-sub">Send downloads to Plex, Apple Music, or a folder.</span>
        ...
        {target === "plex" && (
          <div className="settings-group">
            ...
            <div className="field">
              ...
              <p className="field-hint">Exports into <code>Movies/</code>, <code>TV Shows/</code>, and <code>Music/</code>.</p>
            </div>
            <div className="field">
            ...
            <div className="field">
              ...
              <p className="field-hint">If URL + token are set, Plex rescans after each export.</p>
            </div>
          </div>
        )}
        {target === "generic" && (
          <div className="settings-group">
            ...
            <div className="field">
              ...
              <p className="field-hint">Creates media-ready folders: <code>Movies/Name (Year)/…</code>, <code>TV Shows/Show/Season 01/…</code>, <code>Music/…</code>.</p>
            </div>
          </div>
        )}
        {target === "apple_music" && (
          <div className="settings-group">
            ...
            <p className="field-hint">
              Adds audio directly to Music. Unsupported formats (FLAC/OGG/etc.) are converted to ALAC.
              macOS may prompt for Music automation permission the first time.
            </p>
          </div>
        )}
      </Card>
      ...
      <div className="export-toolbar">
        <Toggle label={`Select all (${visible.length})`} checked={allSelected} onChange={toggleAll} />
        <div className="cat-controls">
          ...
          {visible.map((it) => {
            ...
            return (
              <div className={`export-row${selected.has(it.path) ? " sel" : ""}`} key={it.path}>
                <Toggle checked={selected.has(it.path)} onChange={() => toggle(it.path)} aria-label={`Select ${it.title}`} />
