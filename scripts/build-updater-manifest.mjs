...
///   https://github.com/InfamousVague/TheBlackPearl/releases/latest/download/latest.json
...
const REPO = "InfamousVague/TheBlackPearl";
...
const manifest = {
  ...
  notes: (release.body || "").trim() || `The Black Pearl ${release.tagName}`,
